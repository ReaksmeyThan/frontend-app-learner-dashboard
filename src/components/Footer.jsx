      ...
      <div className="footer-bottom">
        <Container  md={{ span: 12, offset: 2 }}>
          <Row className="text-center text-white text-md-left">
            ...
            <Col xs={12} md={3} className="mb-4 mb-md-0 d-flex flex-column align-items-center">
            ...
            <Col xs={6} md={2} className="mb-4 mb-md-0">
              <h5 className="text-uppercase text-white mb-4 font-weight-bold">Browse Courses</h5>
              <ul className="list-unstyled">
                <li><a href="#">Programming</a></li>
                <li><a href="#">Learn Economics</a></li>
                <li><a href="#">Learn Project</a></li>
                <li><a href="#">Learn Business</a></li>
                <li><a href="#">Learn Software</a></li>
                <li><a href="#">Learn Computer</a></li>
              </ul>
            </Col>

            {/* About Us */}
            <Col xs={6} md={2} className="mb-4 mb-md-0">
              <h5 className="text-uppercase text-white mb-4 font-weight-bold">About Us</h5>
              <ul className="list-unstyled">
            ...
            {/* Media */}
            <Col xs={6} md={2} className="mb-4 mb-md-0">
              <h5 className="text-uppercase text-white mb-4 font-weight-bold">Media</h5>
              <ul className="list-unstyled">
                <li><a href="#">Programming</a></li>
                <li><a href="#">CSR Activities</a></li>
                <li><a href="#">Videos and Photos</a></li>
              </ul>
            </Col>

            {/* Our Members */}
            <Col xs={6} md={3} className="mb-4 mb-md-0">
              <h5 className="text-uppercase text-white mb-4 font-weight-bold">Our Members</h5>
              <ul className="list-unstyled">
